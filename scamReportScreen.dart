...
import 'package:thingqbator/features/scam_report/widgets/location_search_bar.dart';
import 'package:thingqbator/core/utils/error_handler.dart';
...
class _ScamReportScreenState extends State<ScamReportScreen> {
  ...
  Future<void> _reportScam() async {
    ...
    try {
      final user = _firebaseService.currentUser;
      if (user == null) {
        ErrorHandler.showError(context, 'You must be logged in to report a scam');
        return;
      }
                            ...
                            child: Column(
                              children: [
                                LocationSearchBar(
                                  ...
                                  onTap: () =>
                                      setState(() => _showSearchForm = false),
                                ),
                                ...
                                SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: _isSubmitting ? null : _reportScam,
